...
/**
 * LoginDemo - Versión DEMO para probar feature flags sin LaunchDarkly
 * Esta versión te permite toggle entre diseño clásico y nuevo manualmente
 */
const LoginDemo: React.FC = () => {
    ...
    // Estado local para simular el feature flag
    const [useNewDesign, setUseNewDesign] = useState<boolean>(false);
    ...
    return (
        <div className='min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-500 via-purple-500 to-pink-500'>
            {/* Botón de toggle para volver */}
            <button 
                onClick={() => setUseNewDesign(false)}
                className='absolute top-4 right-4 px-4 py-2 bg-gray-800 text-white rounded hover:bg-gray-900 font-bold z-50'
            >
                ← Volver a Diseño Clásico
            </button>
            ...
            <div className='new-login-container bg-white rounded-2xl shadow-2xl p-8 w-96 transform transition-all hover:scale-105'>
                <div className='text-center mb-6'>
                    ...
                    <p className='text-gray-600'>Nuevo diseño mejorado - Demo Feature Flag</p>
                </div>
